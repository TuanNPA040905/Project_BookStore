    ...
    public ArrayList<ChiTietDonHang> selectAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ChiTietDonHang ctdh = new ChiTietDonHang(maChiTietDonHang, dh, sp, (int) soluong, giagoc, giamgia, giaban,
                        thuevat, tongtien);
                ketQua.add(ctdh);
            }
    ...
    public ChiTietDonHang selectById(ChiTietDonHang t) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ketQua = new ChiTietDonHang(maChiTietDonHang, dh, sp, (int) soluong, giagoc, giamgia, giaban, thuevat,
                        tongtien);
                break;
            }
            // Bước 5:
