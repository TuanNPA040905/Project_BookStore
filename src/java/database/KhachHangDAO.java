...
public class KhachHangDAO implements DAOInterface<KhachHang> {
    ...
    public int insert(KhachHang t) {
        ...
        try {
            ...
            st.setBoolean(12, t.isDkyNhanBanTinEmail());
    ...
    public int update(KhachHang t) {
        ...
        try {
            ...
            st.setDate(8, (Date) t.getNgaySinh());
            st.setString(9, t.getSoDienThoai());
            st.setString(10, t.getEmail());
            st.setBoolean(11, t.isDkyNhanBanTinEmail());
    ...
    public int updateInfo(KhachHang t) {
        ...
        try {
            ...
            st.setDate(6, (Date) t.getNgaySinh());
            st.setString(7, t.getSoDienThoai());
            st.setString(8, t.getEmail());
            st.setBoolean(9, t.isDkyNhanBanTinEmail());
